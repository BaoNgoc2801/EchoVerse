        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              A modern livestreaming platform for creators and viewers to connect in real-time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link href="/go-live" className="text-muted-foreground hover:text-foreground transition-colors">
                  Start Streaming
                </Link>
              </li>
              <li>
