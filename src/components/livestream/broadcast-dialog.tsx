          ...
          <Flex direction="column" gap="4" mt="4">
            <label>
              ...
              <input
                  ...
                  className="w-full rounded-md border border-gray-500 bg-gray-900 px-3 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </label>
