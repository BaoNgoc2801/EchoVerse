        ...
        <div className="flex min-h-screen items-center justify-center bg-[#1a1a1a] overflow-auto py-10 px-2">
            <div className="w-full sm:w-3/6 md:w-3/6 bg-[#2c2c2c] p-8 rounded-lg shadow-lg mt-10">
                ...
                <div className="flex justify-center space-x-4 mb-6">
                    <button className="w-1/2 flex items-center justify-center bg-[#4285F4] text-white p-3 rounded-full">
                        <FcGoogle size={24} className="mr-2" /> Google
                    </button>
                    <button className="w-1/2 flex items-center justify-center bg-[#000000] text-white p-3 rounded-full">
                        <AiFillApple size={24} className="mr-2" /> Apple
                    </button>
                </div>
